...
**Next up:**
1. ~~**The app icon**~~ — **done, 4 Sept 2026.** V2b, generated by `python3 tools/make-icons.py`.
2. **A URL** ← the only thing left — Add to Home Screen on the phone needs HTTPS; localhost only installs on the Mac.
