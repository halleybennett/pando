...
| **Dial** | 24-hour ring, midnight top / noon bottom. **Slow-drag fine-adjust**: a normal drag snaps to 5 min, slowing below ~0.75 rad/s unlocks single minutes, and the ticks thicken and turn Klein to say so. |
